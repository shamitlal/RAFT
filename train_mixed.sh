...
python -u train.py --name raft-things --stage things --validation things --restore_ckpt checkpoints/raft-chairs.pth --gpus 0 --num_steps 120000 --batch_size 1 --lr 0.0001 --image_size 400 720 --wdecay 0.0001 --mixed_precision
