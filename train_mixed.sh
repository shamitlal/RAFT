...
python -u train.py --name raft-things --stage things --validation sintel --restore_ckpt checkpoints/5000_raft-things.pth --gpus 0 --num_steps 120000 --batch_size 5 --lr 0.0001 --image_size 320 768 --wdecay 0.0001 --mixed_precision
